...
"""
Group: EJ_Mohammed ( Eslam Mohammed)
Data Challenge :  kernel methods - taught in MoSIG M2 for Data Science
...
Local Aligment Kernel is implemented however not been integrated with the whole script.
"""
############################################# KERNELS ##############################################
class Kernel():
